...
} from "../firebaseFunctions"; // Import your Firebase functions
...
export function SaveGame(props: {
  ...
  async function handleLoad() {
    if (props.userId) {
      ...
      if (data) {
        ...
        upgradeMap
          .get("clickUpgrade")
          ?.loadUpgrade(data.upgrades.clickUpgrade || 0);
        upgradeMap
          .get("autoClicker01")
          ?.loadUpgrade(data.upgrades.autoClicker01 || 0);
        upgradeMap
          .get("autoClicker02")
          ?.loadUpgrade(data.upgrades.autoClicker02 || 0);
        upgradeMap
          .get("autoClicker03")
          ?.loadUpgrade(data.upgrades.autoClicker03 || 0);
        upgradeMap
          .get("autoClicker04")
          ?.loadUpgrade(data.upgrades.autoClicker04 || 0);
        upgradeMap
          .get("autoClicker05")
          ?.loadUpgrade(data.upgrades.autoClicker05 || 0);
        upgradeMap
          .get("autoClicker06")
          ?.loadUpgrade(data.upgrades.autoClicker06 || 0);
        upgradeMap
          .get("autoClicker07")
          ?.loadUpgrade(data.upgrades.autoClicker07 || 0);
        upgradeMap
          .get("autoClicker08")
          ?.loadUpgrade(data.upgrades.autoClicker08 || 0);
        upgradeMap
          .get("autoClicker09")
          ?.loadUpgrade(data.upgrades.autoClicker09 || 0);
        upgradeMap
          .get("autoClicker10")
          ?.loadUpgrade(data.upgrades.autoClicker10 || 0);
        //
        upgradeMap
          .get("refClicker01")
          ?.loadUpgrade(data.upgrades.refClicker01 || 0);
        upgradeMap
          .get("refClicker02")
          ?.loadUpgrade(data.upgrades.refClicker02 || 0);
        upgradeMap
          .get("refClicker03")
          ?.loadUpgrade(data.upgrades.refClicker03 || 0);
        upgradeMap
          .get("refClicker04")
          ?.loadUpgrade(data.upgrades.refClicker04 || 0);
        upgradeMap
          .get("refClicker05")
          ?.loadUpgrade(data.upgrades.refClicker05 || 0);
        upgradeMap
          .get("refClicker06")
          ?.loadUpgrade(data.upgrades.refClicker06 || 0);
        upgradeMap
          .get("refClicker07")
          ?.loadUpgrade(data.upgrades.refClicker07 || 0);
        upgradeMap
          .get("refClicker08")
          ?.loadUpgrade(data.upgrades.refClicker08 || 0);
        upgradeMap
          .get("refClicker09")
          ?.loadUpgrade(data.upgrades.refClicker09 || 0);
        upgradeMap
          .get("refClicker10")
          ?.loadUpgrade(data.upgrades.refClicker10 || 0);
        upgradeMap
          .get("refClicker11")
          ?.loadUpgrade(data.upgrades.refClicker11 || 0);
        upgradeMap
          .get("refClicker12")
          ?.loadUpgrade(data.upgrades.refClicker12 || 0);
        upgradeMap
          .get("refClicker13")
          ?.loadUpgrade(data.upgrades.refClicker13 || 0);
        upgradeMap
          .get("refClicker14")
          ?.loadUpgrade(data.upgrades.refClicker14 || 0);
        //
        upgradeMap
          .get("adsClicker01")
          ?.loadUpgrade(data.upgrades.adsClicker01 || 0);
        upgradeMap
          .get("adsClicker02")
          ?.loadUpgrade(data.upgrades.adsClicker02 || 0);
        upgradeMap
          .get("adsClicker03")
          ?.loadUpgrade(data.upgrades.adsClicker03 || 0);
        upgradeMap
          .get("adsClicker04")
          ?.loadUpgrade(data.upgrades.adsClicker04 || 0);
        upgradeMap
          .get("adsClicker05")
          ?.loadUpgrade(data.upgrades.adsClicker05 || 0);
        upgradeMap
          .get("adsClicker06")
          ?.loadUpgrade(data.upgrades.adsClicker06 || 0);
        upgradeMap
          .get("adsClicker07")
          ?.loadUpgrade(data.upgrades.adsClicker07 || 0);
        upgradeMap
          .get("adsClicker08")
          ?.loadUpgrade(data.upgrades.adsClicker08 || 0);
      }
  ...
  function handleSave() {
    if (props.userId && isDataLoaded) {
      ...
      console.error(
        "Cannot save data: either userId is null or data has not been loaded."
      );
      alert(
        "Cannot save data: either userId is null or data has not been loaded."
      );
